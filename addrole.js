...
run: async (bot, message, args) => {
        ...
        if (!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send("**You Dont Have The Permissions To Add Roles To Users! - [MANAGE_ROLES]**<:recluse:915162075125407786> ");
        if (!message.guild.me.hasPermission("MANAGE_ROLES")) return message.channel.send("<:recluse:915162075125407786> **I Dont Have The Permissions To Add Roles To Users! - [MANAGE_ROLES]**> ");
        
        if (!args[0]) return message.channel.send("**Please Enter A Role!**<:recluse:915162075125407786> ")
        ...
        if (!role) return message.channel.send("**Could Not Find That Role!**<:recluse:915162075125407786> ")
